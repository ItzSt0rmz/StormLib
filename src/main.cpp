...
stormlib::aRGB strand1(4, 15); // 15 diode strand on adi port 'D'
stormlib::aRGB strand2(5, 20); // 20 diode strand on adi port 'E'
stormlib::aRGB strand3(15, 2, 41); // 41 diode strand on an expander, expander on smart port 15, strand on expander port 2
stormlib::aRGB strand4(7, 41); // 41 diode strand on adi port 'G'
stormlib::aRGB strand5(8, 63); // 63 diode strand on adi port 'H'
...
stormlib::aRGB_manager LEDmanager(&strand1, &strand2, &strand3, &strand4,
                                  &strand5, nullptr, nullptr, nullptr);
